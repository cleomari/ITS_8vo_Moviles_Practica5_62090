...
import { createHTML } from 'react-native-pell-rich-editor/src/editor'
import {actions, messages} from 'react-native-pell-rich-editor/src/const'

const PlatformIOS = Platform.OS === 'ios';

export default class CustomRichEditor extends Component {
  static defaultProps = {
    contentInset: {},
    style: {},
    placeholder: '',
